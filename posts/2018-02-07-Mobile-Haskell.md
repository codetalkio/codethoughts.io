...
![1. Create Project](/Users/tehnix/GitHub/codetalk/codetalk.io/resources/images/mobile-haskell/1. Create Project.png)

Choose `Single View Application`,

![1.1. Create Project - Single View Application](/Users/tehnix/GitHub/codetalk/codetalk.io/resources/images/mobile-haskell/1.1. Create Project - Single View Application.png)

And set the name and location of your project,

<table><tr><td>![1.2. Create Project - Name](/Users/tehnix/GitHub/codetalk/codetalk.io/resources/images/mobile-haskell/1.2. Create Project - Name.png)</td><td>![1.3. Create Project - Set Location](/Users/tehnix/GitHub/codetalk/codetalk.io/resources/images/mobile-haskell/1.3. Create Project - Set Location.png)</td></tr></table>
...
![2. Add Source Folder for Haskell Code](/Users/tehnix/GitHub/codetalk/codetalk.io/resources/images/mobile-haskell/2. Add Source Folder for Haskell Code.png)
...
![3. Drag the files to Xcode](/Users/tehnix/GitHub/codetalk/codetalk.io/resources/images/mobile-haskell/3. Drag the files to Xcode.png)
...
![4. Create Objective-C File](/Users/tehnix/GitHub/codetalk/codetalk.io/resources/images/mobile-haskell/4. Create Objective-C File.png)

![4.1. Create Objective-C File - Choose Filetype](/Users/tehnix/GitHub/codetalk/codetalk.io/resources/images/mobile-haskell/4.1. Create Objective-C File - Choose Filetype.png)

![4.2. Create Objective-C File - Set Name](/Users/tehnix/GitHub/codetalk/codetalk.io/resources/images/mobile-haskell/4.2. Create Objective-C File - Set Name.png)

![4.3. Create Objective-C File - Set Location](/Users/tehnix/GitHub/codetalk/codetalk.io/resources/images/mobile-haskell/4.3. Create Objective-C File - Set Location.png)

![4.4. Create Objective-C File - Create Bridging Header](/Users/tehnix/GitHub/codetalk/codetalk.io/resources/images/mobile-haskell/4.4. Create Objective-C File - Create Bridging Header.png)
...
![7. Add Label](/Users/tehnix/GitHub/codetalk/codetalk.io/resources/images/mobile-haskell/7. Add Label.png)
...
![7.1. Add Label - Connect IBOutlet](/Users/tehnix/GitHub/codetalk/codetalk.io/resources/images/mobile-haskell/7.1. Add Label - Connect IBOutlet.png)
...
![5. Build Phases](/Users/tehnix/GitHub/codetalk/codetalk.io/resources/images/mobile-haskell/5. Build Phases.png)

Choose `Add Other...` to locate the library,

![5.1. Build Phases - Add New](/Users/tehnix/GitHub/codetalk/codetalk.io/resources/images/mobile-haskell/5.1. Build Phases - Add New.png)

and finally locate the library file in `hs-src/binaries/iOS/libHSMobileFun.a`,

![5.2. Build Phases - Locate the Library](/Users/tehnix/GitHub/codetalk/codetalk.io/resources/images/mobile-haskell/5.2. Build Phases - Locate the Library.png)
...
![6. Build Settings](/Users/tehnix/GitHub/codetalk/codetalk.io/resources/images/mobile-haskell/6. Build Settings.png)

## Run the Code!

Final step, let's run our code in the simulator

![9. Run Simulator](/Users/tehnix/GitHub/codetalk/codetalk.io/resources/images/mobile-haskell/9. Run Simulator.png)
...
![8. Add libconv to libraries](/Users/tehnix/GitHub/codetalk/codetalk.io/resources/images/mobile-haskell/8. Add libconv to libraries.png)
